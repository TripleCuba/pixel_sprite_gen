...
export const SPRITE_QUALITY_EVAL_CASES: readonly SpriteQualityEvalCase[] = [
  ...
  },
  {
    ...
    prompt:
      "A lone forest ranger drawing a longbow, green hooded cloak, leather boots, and a quiver of arrows.",
  },
  {
  ...
  },
  {
    ...
    prompt:
      "A battle mage in a red robe holding a glowing blue staff, with a small spell book at the belt.",
  },
  {
  ...
  },
  {
    ...
    view: SpriteView.threeQuarter,
    prompt:
      "A small medieval windmill with a timber frame, brick base, four wooden sails, and a shingled roof.",
  },
  {
  ...
  },
  {
    ...
    view: SpriteView.isometric,
    prompt:
      "A cozy timber-frame blacksmith workshop with a stone forge, chimney, stacked firewood, and an iron sign.",
  },
  {
    id: "item-front-01",
  ...
  },
  {
    ...
    view: SpriteView.side,
    prompt:
      "An old iron dungeon key with a circular bow, a long shaft, and two chunky teeth, viewed from the side.",
  },
  {
    ...
    view: SpriteView.threeQuarter,
    prompt:
      "A small oak treasure chest with iron corner bands, a gold lock, and its lid closed.",
  },
  {
    id: "item-top-down-01",
  ...
  },
  {
    ...
    view: SpriteView.isometric,
    prompt:
      "A small stone shrine with a glowing amber crystal set into its top and three worn steps at the front.",
  },
  {
    ...
    view: SpriteView.topDown,
    prompt:
      "A compact grassy hill tile with three pine trees, a few exposed grey rocks, and a narrow dirt trail.",
  },
  {
    ...
    view: SpriteView.isometric,
    prompt:
      "A rocky snow-covered cliff outcrop with layered grey stone, white snow caps, and sparse frozen grass.",
  },
  {

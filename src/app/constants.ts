...
export const SpriteTypeViews: Record<SpriteType, readonly SpriteView[]> = {
  ...
  [SpriteType.building]: [SpriteView.front, SpriteView.threeQuarter, SpriteView.topDown, SpriteView.isometric],
  [SpriteType.item]: [
    SpriteView.front,
    SpriteView.side,
...
export const isSpriteViewAvailableForType = (spriteType: SpriteType, spriteView: SpriteView) =>
